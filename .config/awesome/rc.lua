...
globalkeys = awful.util.table.join(
    ...
    -- Media Keys
    awful.key({                   }, "XF86AudioPlay",         function () sexec("mpc toggle") end),
    awful.key({                   }, "XF86AudioNext",         function () sexec("mpc next") end),
    awful.key({                   }, "XF86AudioPrev",         function () sexec("mpc prev") end),
    awful.key({                   }, "XF86AudioStop",         function () sexec("mpc stop") end),
    awful.key({                   }, "XF86AudioRaiseVolume",  function () sexec("amixer -c 0 set Master 1dB+") end),
    awful.key({                   }, "XF86AudioLowerVolume",  function () sexec("amixer -c 0 set Master 1dB-") end),
    awful.key({                   }, "XF86AudioMute",         function () sexec("amixer -c 0 set Master toggle") end),
    awful.key({                   }, "Print",                 function () sexec("scrot -e 'mv $f ~/screenshots/ 2>/dev/null'") end),
    ...
    awful.key({ modkey, "Control" }, "j",     function () sexec("jdownloader")              end),
    awful.key({ modkey, "Control" }, "p",     function () exec(terminal .. " -e python3") end)
)
